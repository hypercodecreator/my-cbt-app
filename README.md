...
### 1순위: 메타인지 엔진 (Metacognition Engine)
...
### 2순위: 능동적 학습 도구 (Active Study Toolkit)
...
목표: 퀴즈 학습 시 사용자가 문제의 순서와 출처를 명확히 인지할 수 있도록 돕고, 앱의 기본 기능(정렬)의 신뢰성을 확보한다.

완료 사항: 퀴즈 정렬(순차/역순) 기능 정상화, 문제 고유번호 UI 표시.
